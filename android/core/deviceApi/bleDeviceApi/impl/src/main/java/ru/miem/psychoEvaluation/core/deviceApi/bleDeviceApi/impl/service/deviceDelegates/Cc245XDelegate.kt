...
class Cc245XDelegate(
    ...
    override fun connectCharacteristics(gattService: BluetoothGattService): Boolean {
        ...
        val readCharacteristic = gattService.getCharacteristic(BleDevices.BLUETOOTH_LE_CC254X_CHAR_RW)
        val writeCharacteristic = gattService.getCharacteristic(BleDevices.BLUETOOTH_LE_CC254X_CHAR_RW)
